...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex justify-content-between">
            <div class="logo">
                <h1><a href=""><img src="../assets/img/logo.png" alt="" class="img-fluid">RPL</a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="/home#team">Teacher</a></li>
                    ...
                    <li><a class="nav-link scrollto" href="<?= base_url('/admin/login') ?>"><button
                                class="btn btn-primary">Admin</button></a></li>
                </ul>
