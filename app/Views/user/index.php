...
<!-- ======= About Section ======= -->
<section id="about" class="about section-t8 section-bg ">
    <div class="container">
...
<!-- ======= Latest News Section ======= -->
<section id="news" class="testimonials section-news section-t8 section-bg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-1 offset-sm-3">
                <div class="title-link">
                    <a href="<?= base_url('/blog_grid') ?>">More<i class="bi bi-chevron-right"></i>
...
<section id="clients" class="clients ">
    <div class="container">
        ...
        <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
            ...
            <div class="col-lg-3 col-md-4 col-xs-6">
                <div class="client-logo">
                    <img src="assets/img/partner/client-7.png" class="img-fluid" alt="">
                </div>
            </div>

            <div class="col-lg-3 col-md-4 col-xs-6">
                <div class="client-logo">
                    <img src="assets/img/partner/client-8.png" class="img-fluid" alt="">
                </div>
            </div>
